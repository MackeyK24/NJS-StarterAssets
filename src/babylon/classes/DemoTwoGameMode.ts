...
export class DemoTwoGameMode extends ScriptComponent {

    constructor(transform: TransformNode, scene: Scene, properties: any = {}, alias: string = "DemoTwoGameMode") {
        super(transform, scene, properties, alias);
        GameManager.EventBus.OnMessage("OnSceneReady", (data: any) => { this.onSceneReady(data); });
    }

    protected onSceneReady(data: any): void {
        console.log("DemoTwoGameMode - OnSceneReady():", data);
        try {
...
SceneManager.RegisterClass("DemoTwoGameMode", DemoTwoGameMode);